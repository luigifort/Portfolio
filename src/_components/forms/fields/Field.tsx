...
export const fieldBorderStyles = tv({
  ...
  variants: {
    isFocusWithin: {
      false:
        "border-primary-light hover:border-primary dark:border-neutral-600 dark:hover:border-neutral-500 forced-colors:border-[ButtonBorder]",
      true: "border-primary-dark dark:border-neutral-300 forced-colors:border-[Highlight]",
    },
    isInvalid: {
